    ...
    <v-card>
      <v-card-title class="pa-0">
        <v-toolbar dark color="primary">
          <v-spacer />
          <v-toolbar-title>Creación de Banner </v-toolbar-title>
          <v-spacer />
                ...
                <v-card-text>
                  <v-form ref="form2">
                    ...
                    >
                      ...
                      <ImageSizeDialog class="mt-2" :text="'950 x 600 pixels'"/>
                    </v-row>
                  </v-form>
                </v-card-text>
                <v-card-text>
...
<script>
  ...
  export default {
    ...
    methods : {
      openDialog(){
        this.orderlist = [1];
        this.generateList( this.$parent.$parent.banner.length );
        this.dialog = true;
      },
      ...
      generateList( number ){
        ...
        this.orderlist = (this.orderlist.length > 0) ? this.orderlist : [1]
      }
    }
  }
</script>
