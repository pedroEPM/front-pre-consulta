    ...
    <v-dialog v-model="confirm1" max-width="300" persistent>
      <v-card >
        ...
        <v-card-text>
          ...
          <!-- <h3>¿Quieres generar el reporte de "{{ tituloI }}"?</h3> -->
        </v-card-text>
            ...
            <div style="padding-left: 20px;">
              ...
              <div style="padding-left: 20px">
                <v-row>
                  <v-col cols="8">
                    <center>
                      <img :src="imgchart" width="900" alt="img" />
                    </center>
                  </v-col>
                  <!--<v-col>
                  ...
                  <v-col cols="8">
                    <center>
                      <img :src="imgchart2" width="900" alt="img" />
                    </center>
                  </v-col>
                  <!--<v-col>
                    <div style="padding-top:30px; padding-right:10px">
...
export default {
  ...
  methods: {
    ...
    //hicimos un regreso xd
    async openDialog(
     title, iffecha, img3, img4, fechaexpedido
    ) {
      console.log('entro al print', title)
     // await this.limpieza();
      ...
      console.log('impresion other', title, iffecha, img3, img4, fechaexpedido)
      this.imgchart = img3;
      this.imgchart2 = img4;
      ...
      this.titulodoc = this.tituloI + "-" + fechaexpedido;
      this.confirm1 = true;
      this.titlereport ="hola mundo"
    },
