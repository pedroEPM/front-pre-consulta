          ...
          <section slot="pdf-content">
            ...
            <div style="padding-left: 20px; padding-top: 20px">
              ...
              <br/>
                 ...
                 <br />
            <div style="padding-left: 20px; padding-top: 20px">
              <h4>Datos del usuario reportado</h4>
              <div>
                <v-row>
                  <v-col cols="6">
                    <div style="padding: 1px">
                      <center>
                        <h5 style="color: grey">Nombre:</h5>
                        <p
                          style="font-size: 16px; font-weight: 500; color: gray"
                        >
                          {{ userData.name }}
                  ...
                  <v-col>
                    <div style="padding: 1px">
                      <center>
                        <h5 style="color: grey">Correo electrónico</h5>
                        <p
                          style="font-size: 16px; font-weight: 500; color: gray"
                        >
                          {{userData.email}}
...
export default {
  ...
  methods: {
    ...
    async openDialog(
      ...
      this.dataLabel = infocharthead;
      this.dataInfo = infochartpdf;
        ...
        switch (mode) {
          case 'general':
           ...
           // this.infocharthead[2] = { text: "" };
            this.ifgeneral = true;
            this.titlereport = 'Gráfica de reporte de consultas del usuario'
            break;
